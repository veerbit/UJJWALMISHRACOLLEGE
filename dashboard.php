...
$query13=mysqli_query($con,"SELECT CoreSubject,COUNT(*) as COUNT FROM `2023_27_2024_2028` GROUP BY CoreSubject");
$tsubjects13=mysqli_num_rows($query13);
//$res=mysqli_fetch_array($tsubjects13)
//$query1=mysqli_query($con,"SELECT subid FROM subject");
//$tsubjects=mysqli_num_rows($query1);
?>

                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo htmlentities($tsubjects13);?></div>
                                    <div>Subjects</div>
                                </div>
                            </div>
                        </div>
